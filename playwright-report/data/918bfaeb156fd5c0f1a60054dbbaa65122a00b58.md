...
- Name: Storybook動作確認 >> DocbaseMarkdownPreview - Default Storyが表示される
- Location: /Users/nishioka/Develop/notebooklm-collector/tests/storybook.spec.ts:30:7
...
Call log:
  - waiting for locator('#features-docbase-components-docbasemarkdownpreview--default')
    ...
    at /Users/nishioka/Develop/notebooklm-collector/tests/storybook.spec.ts:41:88
```
