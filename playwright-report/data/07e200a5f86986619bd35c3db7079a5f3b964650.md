...
- Name: Storybook動作確認 >> DocbaseMarkdownPreview - Empty Storyが表示される
- Location: /Users/nishioka/Develop/notebooklm-collector/tests/storybook.spec.ts:56:7
...
Call log:
  - waiting for locator('#features-docbase-components-docbasemarkdownpreview--empty')

    at /Users/nishioka/Develop/notebooklm-collector/tests/storybook.spec.ts:67:86
```
